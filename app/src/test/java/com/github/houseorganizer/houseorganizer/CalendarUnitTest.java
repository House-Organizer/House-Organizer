...
public class CalendarUnitTest {
    ...
    public void setAndGetWorkProperly() {
        ...
        events.add(new Event("My event", "this is my event", LocalDateTime.of(LocalDate.now(), LocalTime.NOON), TEST_ID));
    ...
    public void EventsAreProperlySorted() {
        Calendar calendar = new Calendar();
        Event e1 = new Event("My event", "this is my event", LocalDateTime.of(LocalDate.now(), LocalTime.NOON.minus(0, ChronoUnit.HOURS)), TEST_ID);
        Event e2 = new Event("My event", "this is my event", LocalDateTime.of(LocalDate.now(), LocalTime.NOON.minus(3, ChronoUnit.HOURS)), TEST_ID);
        Event e3 = new Event("My event", "this is my event", LocalDateTime.of(LocalDate.now(), LocalTime.NOON.minus(8, ChronoUnit.HOURS)), TEST_ID);
        ArrayList<Event> events = new ArrayList<>();
        events.add(e1);
        events.add(e2);
        events.add(e3);
    ...
    public void throwsExceptionOnNullTitle() {
        assertThrows(NullPointerException.class, () -> new Event(null, "", LocalDateTime.now(), TEST_ID));
    }

    @Test
    public void throwsExceptionOnNullStart() {
        assertThrows(NullPointerException.class, () -> new Event("title", "", null, TEST_ID));
    }

    @Test
    public void descriptionIsCorrectlyReplacedByEmptyStringOnNull() {
        Event event = new Event("title", null, LocalDateTime.now(), TEST_ID);
    ...
    public void getTitleReturnsCorrectly() {
        String title = "title";
        Event event = new Event(title, "", LocalDateTime.now(), TEST_ID);
    ...
    public void getDescriptionReturnsCorrectly() {
        String desc = "desc";
        Event event = new Event("title", desc, LocalDateTime.now(), TEST_ID);
    ...
    public void getStartReturnsCorrectly() {
        ...
        Event event = new Event("title", "", start, TEST_ID);
        assertEquals(start, event.getStart());
    }

    @Test
    public void equalsReturnsTrueOnSameEvents() {
        Event event1 = new Event("title", "desc", LocalDateTime.of(LocalDate.of(2000, 1, 1), LocalTime.NOON), TEST_ID);
        Event event2 = new Event("title", "desc", LocalDateTime.of(LocalDate.of(2000, 1, 1), LocalTime.NOON), TEST_ID);
    ...
    public void equalsReturnsFalseOnDifferentEvents() {
        Event event1 = new Event("title", "desc", LocalDateTime.of(LocalDate.of(2000, 1, 1), LocalTime.NOON), TEST_ID);
        Event event2 = new Event("titl", "desc", LocalDateTime.of(LocalDate.of(2000, 1, 1), LocalTime.NOON), TEST_ID);
