...
public class QRCodeScanActivityTest {
    ...
    public void acceptInviteFailsOnInvalidID() throws ExecutionException, InterruptedException {
        ...
        QRJoinRule.getScenario().onActivity(qrCodeScanActivity -> qrCodeScanActivity.acceptInvite("not_a_valid_household_id")).getResult();
        Thread.sleep(1000);
    ...
    public void acceptInviteWorksOnValidID() throws ExecutionException, InterruptedException {
        ...
        QRJoinRule.getScenario().onActivity(qrCodeScanActivity -> qrCodeScanActivity.acceptInvite(TEST_HOUSEHOLD_NAMES[0])).getResult();
        Thread.sleep(1000);
